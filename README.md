...
| 07 | `design/DESIGN_07_ROBUSTNESS_AND_SECURITY_HARDENING.md` | Adversarial 6-lens red-team (R1-R9) **plus sixty-two more findings, R10..R71, produced by BUILDING it** -- the register runs R1..R71 with no gaps | the whole verified base + 01/08 |
